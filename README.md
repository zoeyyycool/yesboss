...
一个强大的Boss直聘职位信息获取工具，支持任意关键词搜索，多种配置生成方式，已优化反爬虫机制。

## 🚀 主要功能

✅ **任意关键词搜索** - 支持搜索任何职位类型（Python开发、产品经理、UI设计师等）  
...
```bash
# 搜索Python开发岗位
python3 quick_config.py "Python开发@北京,15-30k,3-5年,本科"

# 搜索产品经理岗位
python3 quick_config.py "产品经理@上海,20-40k,3-5年,本科"

# 搜索前端开发岗位
python3 quick_config.py "前端开发@深圳,15-25k,1-3年,本科"
```
...
# 使用产品经理模板
python3 template_config.py product_manager 广州,杭州
```
...
```bash
# Python开发工程师
python3 quick_config.py "Python开发@北京,20-40k,3-5年,本科,1000-9999人"

# Java后端开发
python3 quick_config.py "Java开发@上海,25-45k,3-5年,本科"

# 前端开发工程师
python3 quick_config.py "前端开发@深圳,18-30k,1-3年,本科"
```

### 搜索产品岗位
```bash
# 产品经理
python3 quick_config.py "产品经理@杭州,20-35k,3-5年,本科"

# UI设计师
python3 quick_config.py "UI设计@广州,12-20k,1-3年,本科"
```

### 搜索运营岗位
```bash
# 用户运营
python3 quick_config.py "用户运营@成都,10-18k,1-3年,本科"

# 内容运营
python3 quick_config.py "内容运营@武汉,8-15k,1-3年,本科"
```
...
[
  {
    ...
    "experience": "3-5年",
    "city": "北京",
    "desc": "负责后端服务开发，熟悉Django/Flask框架...",
...
- **求职者** - 批量搜索任意类型职位，提高求职效率
- **HR和招聘** - 了解各行业岗位市场行情和薪资水平
- **数据分析师** - 职场数据分析和行业趋势研究  
- **猎头顾问** - 快速获取候选人和职位信息
- **市场研究** - 了解不同城市和行业的人才需求
